...
export const hotelsByCountry: Record<string, HotelOption[]> = {
  Turkey: [
...
export const boardTypes: Array<{
  code: BoardCode
  name: string
  description: string
}> = [
  { code: 'FB', name: 'Full Board', description: 'Lunch & dinner included' },
  { code: 'HB', name: 'Half Board', description: 'Lunch or dinner per day' },
  { code: 'NB', name: 'No Board', description: 'Meals excluded' },
]

export const mealOptions: Record<
  string,
  { lunch: MealOption[]; dinner: MealOption[] }
> = {
  Turkey: {
    dinner: [
